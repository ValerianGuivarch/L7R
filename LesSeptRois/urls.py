...
urlpatterns = [
    ...
    path('mj/lancer_pnj2/<str:nom>/<str:action>/<int:stat>/<str:pf>/<str:pp>/<str:ra>/<int:mal>/<int:ben>/<str:secret>/<int:des_caches>', applsr_views.lancer_pnj2),
