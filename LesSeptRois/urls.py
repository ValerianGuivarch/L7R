...
urlpatterns = [
    ...
    path(
        'mj/updateviking/<str:nom>/<str:agriculture>/<str:charisme>/<str:combat>/<str:magie>/<str:savoir>/<str:navigation>/<str:nature>/<str:point_de_vie_max>',
        applsr_views.updateviking),
    path(
        'mj/newviking/<str:joueur>/<str:nom>/<str:role>/<str:agriculture>/<str:charisme>/<str:combat>/<str:magie>/<str:savoir>/<str:navigation>/<str:nature>/<str:point_de_vie_max>',
        applsr_views.newviking),
    ...
    path('mj/lancer_pnj/<str:nom>/<str:action>/<int:stat>/<str:pf>/<str:pp>/<str:ra>/<int:mal>/<int:ben>/<str:secret>/<str:des_caches>/<int:opposition>',
        applsr_views.lancer_pnj),
    path('mj/lancer_pnj2/<str:nom>/<str:action>/<int:stat>/<str:pf>/<str:pp>/<str:ra>/<int:mal>/<int:ben>/<str:secret>/<int:des_caches>',
        applsr_views.lancer_pnj2),
    path('mj/updatepj/<str:nom>/<str:chair>/<str:esprit>/<str:essence>/<str:point_de_vie_max>/<str:point_de_focus_max>/<str:point_de_pouvoir_max>/<str:niveau>',
         applsr_views.updatepj),
]
